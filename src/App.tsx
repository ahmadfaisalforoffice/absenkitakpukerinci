          ...
          <div className="flex flex-col h-full justify-between gap-3">
            ...
            {!checkOut && (
              <motion.button 
                ...
                className="w-full py-5 bg-gradient-to-r from-brand-600 to-brand-700 text-white rounded-[2.5rem] font-bold shadow-xl shadow-brand-500/30 flex items-center justify-center gap-3 transition-all group mb-4"
              >
