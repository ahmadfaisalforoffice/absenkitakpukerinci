            ...
            <div>
              {error && (
                <motion.div 
                  ...
                  animate={{ opacity: 1, y: 0 }} 
                  className="bg-red-50 border border-red-100 p-2.5 rounded-xl flex items-center gap-2 mb-3"
                >
                ...
                >
                  <div className="relative z-10">
                    ...
                    <div className="flex gap-3">
                      <div className="flex-1 bg-white/5 rounded-2xl p-3.5 border border-white/10 backdrop-blur-md">
