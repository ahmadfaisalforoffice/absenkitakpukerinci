...
export default function App() {
  ...
  return (
    <div className="h-screen bg-[#F8FAFC] flex flex-col max-w-md mx-auto shadow-2xl relative overflow-hidden">
      {/* Header */}
      <header className="py-3 px-4 glass sticky top-0 z-30 flex justify-between items-center border-b-0 rounded-b-[2rem]">
            ...
            <div>
              {error && (
                <motion.div 
                  ...
                  animate={{ opacity: 1, y: 0 }} 
                  className="bg-red-50 border border-red-100 p-2 rounded-xl flex items-center gap-2 mb-2"
                >
              ...
              <div className="space-y-3">
                  ...
                  <div className="relative z-10">
                    ...
                    <div className="flex gap-3">
                      <div className="flex-1 bg-white/5 rounded-2xl p-3 border border-white/10 backdrop-blur-md">
                        <p className="text-[8px] font-bold uppercase tracking-widest text-slate-400 mb-0.5">In Schedule</p>
                        <p className="text-sm font-bold">{schedule?.start || '--:--'}</p>
                      </div>
                      <div className="flex-1 bg-white/5 rounded-2xl p-3 border border-white/10 backdrop-blur-md">
                        <p className="text-[8px] font-bold uppercase tracking-widest text-slate-400 mb-0.5">Out Schedule</p>
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  >
                    <div className="flex items-center gap-2 mb-1.5">
                      <div className={cn("w-7 h-7 rounded-xl flex items-center justify-center transition-colors", checkIn ? "bg-emerald-500 text-white shadow-lg shadow-emerald-500/30" : "bg-slate-50 text-slate-300")}>
                  ...
                  >
                    <div className="flex items-center gap-2 mb-1.5">
                      <div className={cn("w-7 h-7 rounded-xl flex items-center justify-center transition-colors", checkOut ? "bg-brand-500 text-white shadow-lg shadow-brand-500/30" : "bg-slate-50 text-slate-300")}>
                        <LogOut className="w-4 h-4" />
                      </div>
                ...
                <div className="glass p-3.5 rounded-[2rem] flex items-center justify-between card-hover">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className={cn("text-xs font-bold", distance !== null && distance <= OFFICE_LOCATION.radius ? "text-slate-900" : "text-red-500")}>
                        {distance !== null ? (distance <= OFFICE_LOCATION.radius ? "Dalam Jangkauan" : `${Math.round(distance)}m`) : "Searching..."}
                      </p>
                    </div>
                  </div>
                  <button onClick={requestLocation} className="p-2 bg-brand-50 text-brand-600 rounded-xl hover:bg-brand-100 transition-colors">
